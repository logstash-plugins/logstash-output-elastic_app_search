...
[![Unit Tests](https://github.com/logstash-plugins/logstash-output-elastic_app_search/actions/workflows/unit-tests.yml/badge.svg?branch=main)](https://github.com/logstash-plugins/logstash-output-elastic_app_search/actions/workflows/unit-tests.yml)
