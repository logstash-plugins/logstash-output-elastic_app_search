...
This output lets you send events to the Elastic App Search for the 
different deployment types:

- https://www.elastic.co/guide/en/cloud/current/ec-enable-enterprise-search.html[Enterprise Search on Elastic Cloud]
- https://www.elastic.co/downloads/enterprise-search[Self-managed App Search]
- https://swiftype.com/documentation/app-search/getting-started[App Search on Swiftype SaaS]
...
The private API Key with write permissions. Visit https://www.elastic.co/guide/en/app-search/current/authentication.html#authentication-key-types[Credentials] in the App Search dashboard to find the key associated with your account.
...
https://swiftype.com/documentation/app-search/getting-started[App Search on Swiftype SaaS]
 only.  The https://swiftype.com/documentation/app-search/authentication[host identifier] of the App Search API that is associated with your App Search account.
...
https://www.elastic.co/downloads/enterprise-search[Self-managed App Search] only.  Optional.  The path that is appended to the `url` parameter if different from the default.
...
https://www.elastic.co/guide/en/cloud/current/ec-enable-enterprise-search.html[Enterprise Search on Elastic Cloud] and https://www.elastic.co/downloads/enterprise-search[Self-managed App Search] only.  The value of the API endpoint in the form of a URL. Note: The value of the `path` setting will be appended to this URL automatically.

Enterprise Search on Elastic Cloud example:

[source,ruby]
"url" => "https://<deployment_id>.ent-search.<region_id>.<cloud_provider_id>.cloud.es.io"
